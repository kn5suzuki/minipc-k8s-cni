...
[2.13](02-calico.md#213-calico-のアンインストール-cni-未導入の状態に戻す) を
完了していれば、この状態になっています。
...
前章 (例えば [2.13](02-calico.md#213-calico-のアンインストール-cni-未導入の状態に戻す))
...
`nginx-ds` / `debug` も前章のアンインストール手順 (例: 2.13) で削除済みの前提
